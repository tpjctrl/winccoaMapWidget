# Lit for Polymer users – Lit

Aug 22, 2022 — Updated Aug 22, 2022

## Contents

1.  [How does Lit relate to Polymer?](#how-does-lit-relate-to-polymer)
2.  [Migrating from Polymer to Lit](#migrating)
    1.  [Updating to Polymer 3](#updating-to-polymer-3)
    2.  [Language support](#language-support)
    3.  [Removing two-way bindings](#removing-two-way-bindings)
3.  [Polymer to Lit cookbook](#polymer-to-lit-cookbook)
    1.  [Defining a component](#defining-a-component)
    2.  [DOM template](#dom-template)
    3.  [Styles](#styles)
    4.  [Data binding](#data-binding)
    5.  [Two-way bindings](#two-way-bindings)
    6.  [Properties](#properties)
    7.  [Computed properties and observers](#computed-properties-and-observers)
4.  [Mixins](#mixins)
...
[Permalink to “How does Lit relate to Polymer?”](#how-does-lit-relate-to-polymer)
...
[Permalink to “Migrating from Polymer to Lit”](#migrating)
...
[Permalink to “Updating to Polymer 3���](#updating-to-polymer-3)
...
[Permalink to “Language support”](#language-support)
...
### Removing two-way bindings

[Permalink to “Removing two-way bindings”](#removing-two-way-bindings)
...
[Permalink to “Issues with two-way binding”](#issues-with-two-way-binding)
...
[Permalink to “Replacing two-way bindings”](#replacing-two-way-bindings)
...
[Permalink to “Polymer to Lit cookbook”](#polymer-to-lit-cookbook)
...
export class MyElement extends PolymerElement { /_ ... _/ }
...
export class MyElement extends LitElement { /_ ... _/ }
...
For more information on Lit templates, see [Templates overview](https://lit.dev/docs/templates/overview/).
...
For more information, see [Styles](https://lit.dev/docs/components/styles/).
...
*   Property expressions. Lit uses the literal property name, prefixed with a period. Polymer uses the corresponding [attribute name](https://polymer-library.polymer-project.org/3.0/docs/devguide/properties#property-name-mapping).
...
[Permalink to “Two-way bindings”](#two-way-bindings)
...
[Permalink to “Conditional templates”](#conditional-templates)
...
[Permalink to “Hiding or recreating DOM”](#hiding-or-recreating-dom)
...
[Permalink to “Repeating templates”](#repeating-templates)
...
For more information, see [Lists](https://lit.dev/docs/templates/lists/), or try our interactive tutorial on [working with lists](https://lit.dev/tutorials/working-with-lists/).
...
For examples using both techniques, see [Listening to events fired from repeated elements](about:/docs/components/events/#listening-to-events-fired-from-repeated-templates) in the Events section.
...
[Permalink to “Configuring properties”](#configuring-properties)
...
[Permalink to “Static getter versus static class field”](#static-getter-versus-static-class-field)
...
[Permalink to “Array & object type properties”](#array-and-object-type-properties)
...
[Permalink to “Read-only properties”](#read-only-properties)
...
[Permalink to “Computed properties and observers”](#computed-properties-and-observers)
...
[Permalink to “Computing transient values in render()”](#computing-transient-values-in-render\(\))
...
[Permalink to “Computing properties in willUpdate()”](#computing-properties-in-willupdate\(\))
...
In addition, Lit components have a set of callbacks that can be used to customize the [reactive update cycle](about:/docs/components/lifecycle/#reactive-update-cycle).
...
For more information, see [Completing an update](about:/docs/components/lifecycle/#reactive-update-cycle-completing).

[Edit this page](https://github.com/lit/lit.dev/edit/main/packages/lit-dev-content/site/articles/article/lit-for-polymer-users.md)
```
